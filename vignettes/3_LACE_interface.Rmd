...
![](./resources/figure4c.png){width="95%"}
...
![](./resources/figure5d.png){width="95%"}
...
| Minimum depth (field 4.1)         | 3      | $0 \leq x \ll C$   | Bigger values, implies more NA sites per time point. |
| Max missing value (field 4.2)     | 0.4    | $0\leq x\leq 1$    | Higher values, keep mutational sites for which larger number of cells has NA value. |
| Minimum median depth (field 4.3)  | 8      | $1\leq x < \sim C$ |	Bigger values keep only locus with bigger median coverege among cells. |
| Minimum alt median depth (field 4.4)| 4    | $1\leq x < \sim C$ | Bigger values keep only mutations with more supporting read in the cell population. |
| Learning rate  (field 5.1)        | 1      |           | Higher values to avoid local minima, but less accurate. |
| False positive rates (field 5.2)  |        | $0<x<1$   | Lower values, for more constraining data values. |
| False negative rates (field 5.3)  |        | $0<x<1$   | Lower values, for more constraining data values. |
...
![](./resources/figure6c.png){width="95%"}
